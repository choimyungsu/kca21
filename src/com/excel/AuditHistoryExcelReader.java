...
public class AuditHistoryExcelReader {
	 ...
	 * @return
	 */
	public List<AuditHistory> xlsxToDB(String filePath) {
		// 諛섑솚�븷 媛앹껜瑜� �깮�꽦
						...
						if(!"".equals(curRow.getCell(0).getStringCellValue())) {
							...
							for(int cellIndex=0;cellIndex<curRow.getPhysicalNumberOfCells(); cellIndex++) {
								...
								if(true) {
									...
									case 1: // audityearmonth
										vo.setAudityearmonth(value);
										break;
									...
									case 6: // auditrole
										vo.setAuditrole(value);
										break;	
										
									case 7: // joinrate
										vo.setJoinrate(value);
										break;											
