...
public class CertiExcelReader {
	 ...
	 * @return
	 */
	public List<Certi> xlsxToDB(String filePath) {
		// 諛섑솚�븷 媛앹껜瑜� �깮�꽦
		List<Certi> list = new ArrayList<Certi>();
						...
						if(!"".equals(curRow.getCell(0).getStringCellValue())) {
							...
							for(int cellIndex=0;cellIndex<curRow.getPhysicalNumberOfCells(); cellIndex++) {
								...
								if(true) {
									...
									case 3: // certiDivision
										vo.setCertidivision(value);
										break;
									
									case 4: // certiField
										vo.setCertifield(value);
										break;
